        ...
        function HandlePaging () {
            ...
            if (server_paging) {
                ...
                promise.success(function (response, status, headers, config) {
                    ...
                    var totalCount = headers()['product-count'];
                    var pages      = totalCount / tableObject.pageSize;
                    var reqTime = new Date().getTime() - startTime;

                    if (totalCount % tableObject.pageSize > 0)
                        pages++;
                    ...
                    $scope.$parent.productCount = totalCount;
                    $scope.$parent.requestTime = reqTime;
